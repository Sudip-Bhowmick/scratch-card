...
<html>
 <head>
  ...
  <style type="text/css">
    ...
    table tr th:first-child, table tr td:first-child {display:none !important}
  </style>
 </head>
 <body>
  <br />
  <div class="container">
    <div class="note">
      Image name should be like given below and only jpg image is accepted<br>
      <span>01, 02, 03, ...., 30, 31</span>
    </div>
   <div align="center">
